...
gs.scr = pcaScreePlot(spi.pca, size=2, 
                      title="")
print(gs.scr)
...
spi.pca.plots0 = pcaPlots(spi.pca, label.df[,c(1,3)], colorsList, colVars,
...
png("figures/Grun_reads_cutoff/spikein_pca_scatter.png", width = 720, height = 720)
pcaPlotter(spi.pca.plots0)
dev.off()

png("figures/Grun_reads_cutoff/spikein_scree_plot.png", width = 720, height = 720)
print(gs.scr)
dev.off()
