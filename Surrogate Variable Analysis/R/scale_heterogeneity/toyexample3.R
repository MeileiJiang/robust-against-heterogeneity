...
# Feature 2 is batch effect. For Batch 1, X2 ~ N(0, 0.01); for Batch 2, X2 ~ N(0,2)
# Other features are random noise.

X1 = c(rep(4, 40), rep(-4, 40))
X2 = c(rnorm(20, 0, 0.1), rnorm(20, 0, 2), rnorm(20, 0, 0.1), rnorm(20, 0, 2))
...
save(train,file = "rdata/scaleToyexample.RData")
