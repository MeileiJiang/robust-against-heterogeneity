#################################################################################
## unbalanced_scale_hetero_SV_detect_case2.R
...
# save the plots
pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg1.1.pdf', height  = 10, width = 8)
print(ubg1.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg2.1.pdf')
print(ubg2.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg3.1.pdf')
print(ubg3.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg4.1.pdf', height  = 10, width = 8)
print(ubg4.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg5.1.pdf', height  = 10, width = 8)
print(ubg5.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg6.1.pdf')
print(ubg6.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg7.1.pdf')
print(ubg7.1)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg8.1.pdf')
print(ubg8.1)
dev.off()
#############################################################################
...
# save the plots
pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg1.2.pdf', height  = 10, width = 8)
print(ubg1.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg2.2.pdf')
print(ubg2.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg3.2.pdf')
print(ubg3.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg4.2.pdf', height  = 10, width = 8)
print(ubg4.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg5.2.pdf', height  = 10, width = 8)
print(ubg5.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg6.2.pdf')
print(ubg6.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg7.2.pdf')
print(ubg7.2)
dev.off()

pdf(file = 'figures/scale_heterogeneity/unbalance_case2/ubg8.2.pdf')
print(ubg8.2)
dev.off()
