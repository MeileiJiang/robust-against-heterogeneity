...
print(paste0("The number of surrogate variable by asymptotic approach: ", n.sv0))
n.sv = num.sv(Edata,mod,method="be", B = 1000)
print(paste0("The number of surrogate variable by permutation test: ", n.sv))
...
ggplot(MR, aes(x = Var2, y = Var1, fill = value)) +
  labs(x = "Sample", y = "Gene", fill = "Value",title = "Residual Matrix") +
  geom_tile() + 
  scale_fill_gradient2()
...
ggplot(data = pv_stat, aes(x = Var2, y = Median) )+ 
  ...
  ylim(0, 0.08) +
  labs(x = "PC", y = "Proportion of Variance", title = "Boxplot of Variance for PCs \n Permuting within columns")
...
ggplot(data = EpvMat, aes(x = Var2, y = value, group = Var1)) + 
  ...
  ylim(0, 0.08) +
  labs(x = "PC", y = "Proportion of Variance", title = "Scree plot of Variance for PCs \n Permuting within columns")
...
R.dir = R.pc$dirDf
R.cor = data.frame(PC = colnames(R.dir), angle = acos(abs(cor(R.dir, y)))/pi * 180 )
...
ggplot(data = R.cor, aes(x = PC, y = angle))+ 
  ...
  labs(x = "PC", y = "Angle", title =paste0("Angles between PCs and Batch Effect \n blue dashed line: angle(SV, Batch Effect) \n pi_1 = ", pi_1, ", pi_2 = ", pi_2, "\n p_1 = ", p_1, ", p_2 = ", p_2)) + 
  scale_y_continuous(limits = c(0, 90), breaks = seq(0, 90, by = 15))
```
...
title_ubg8.1 = paste0("Angles between PCs and Batch Effect \n blue dashed line: angle(SV, Batch Effect) \n pi_1 = ", pi_1, 
              ", pi_2 = ", pi_2, "\n p_1 = ", p_1, ", p_2 = ", p_2)
title_ubg9.1 = paste0("Residual Matrix \n pi_1 = ", pi_1, 
                      ", pi_2 = ", pi_2, "\n p_1 = ", p_1, ", p_2 = ", p_2)
...
title_ubg8.2 = paste0("Angles between PCs and Batch Effect \n blue dashed line: angle(SV, Batch Effect) \n pi_1 = ", pi_1, 
              ", pi_2 = ", pi_2, "\n p_1 = ", p_1, ", p_2 = ", p_2)
title_ubg9.2 = paste0("Residual Matrix \n pi_1 = ", pi_1, 
                      ", pi_2 = ", pi_2, "\n p_1 = ", p_1, ", p_2 = ", p_2)
...
print(paste0("The number of surrogate variable by asymptotic approach: ", n.sv10))

n.sv1 = num.sv(Edata1, mod1, method="be", B = 1000)

print(paste0("The number of surrogate variable by permutation test: ", n.sv1))
...
print(paste0("The number of surrogate variable by asymptotic approach: ", n.sv20))
...
MR1 = melt(R1)
ubg9.1 = ggplot(MR1, aes(x = Var2, y = Var1, fill = value)) +
  labs(x = "Sample", y = "Gene", fill = "Value",title = title_ubg9.1) +
  geom_tile() + 
  scale_fill_gradient2()
print(ubg9.1)
...
MR2 = melt(R2)
ubg9.2 = ggplot(MR2, aes(x = Var2, y = Var1, fill = value)) +
  labs(x = "Sample", y = "Gene", fill = "Value",title = title_ubg9.2) +
  geom_tile() + 
  scale_fill_gradient2()
print(ubg9.2)
...
MR2 = melt(R2)
ubg9.2 = ggplot(MR1, aes(x = Var2, y = Var1, fill = value)) +
  labs(x = "Sample", y = "Gene", fill = "Value",title = title_ubg9.2) +
  geom_tile() + 
  scale_fill_gradient2()
print(ubg9.2)
...
library(limma)
library(reshape2)
load("/Users/meileijiang/researchspace/robust-against-heterogeneity/Surrogate Variable Analysis/rdata/bladder.RData")
# data processing
data(bladderdata)
...
# estimate the number of latent factors that need to be estimated
n.sv0 = num.sv(edata,mod,method="leek")
print(paste0("Number of surrogate variable by asymptotic approach: ", n.sv0))
