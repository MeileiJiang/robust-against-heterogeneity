...
- $X_2$ is the batch effects. For Batch 1, $X_2 \sim \mathbb{N}(2, 1)$; for Batch 2, $X_2 \sim \mathbb{N}(-2, 1)$. $\pi_1$ of Class 1 from Batch 1 and $\pi_2$ of Class 2 from Batch 1. The others from Batch 2. Then the propotion of samples from Batch 1 and Batch 2 are $p_1 = \frac{\pi_1 + \pi_2}{2}$ and $p_2 = 1 - p_1$ respectively.
